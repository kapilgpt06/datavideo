...
class CreateVideoService {
    ...
    void convert(String year1,String electtionType,String constituencyName1) throws Exception {
        ...
        Constituency constituency=Constituency.findByYearAndElectionTypeAndConstituencyName(year1,electtionType,constituencyName1)
            ...
            saveSubtitle();
            setConfigFileTime(String.valueOf(to), "election_"+year+"_"+electtionType+"_"+constituencyName);
